...
export class DiagramStyles {
  ...
  public applyNodeDefault(
    ...
    nodeShape
      ...
      .attr("d", (d: unknown) =>
        nodeStateDefault.shapeSuperformula.getPath(d as Node)
      )
      .attr("stroke-width", (d: unknown) => 1)
      .attr("stroke", (d: unknown) =>
        constants.colorScale(utils.strToLowerOrEmpty((d as Node).group))
      )
      .attr("fill", (d: unknown) =>
        constants.colorScale(utils.strToLowerOrEmpty((d as Node).group))
      )
    ...
    nodeText
      .style("opacity", (d: unknown) =>
        utils.nodeTextOpacity(d as Node, this.showAllLabels)
      )
  ...
  public applyNodeSearch(
    ...
    nodeShape
      ...
      .attr("d", (d: unknown) =>
        nodeStateSearch.shapeSuperformula.getPath(d as Node)
      );
    nodeText
      .transition()
      ...
      .attr("transform", (d: unknown) => {
        return utils.nodeTextShiftRight(
          d as Node,
          nodeStateSearch.nodeTextShiftMultiplier
        );
      });
  }

  public applyNodeHighlight(
    nodeEles: d3.Selection<SVGGElement, Node, d3.BaseType, any>
  ) {
    clearStates(nodeEles);
    ...
    nodeShape
      ...
      .duration(durationMedium)
      .attr("d", (d: unknown) =>
        nodeStateHighlight.shapeSuperformula.getPath(d as Node)
      )
      .attr("stroke", () =>
        utils.darkenIfInvertedBackground(
          constants.highlightColor,
          this.invertedBackground
        )
      )
      .attr("fill", () =>
        utils.darkenIfInvertedBackground(
    ...
    nodeText
      ...
      .attr("transform", (d: unknown) => {
        return utils.nodeTextShiftRight(
          d as Node,
          nodeStateHighlight.nodeTextShiftMultiplier
        );
      });
  }

  public applyNodeHighlightedNeighbour(
    nodeEles: d3.Selection<SVGGElement, Node, d3.BaseType, any>
  ) {
    clearStates(nodeEles);
    ...
    nodeShape
      ...
      .duration(durationLong)
      .attr("d", (d: unknown) =>
        nodeStateHighlightNeighbour.shapeSuperformula.getPath(d as Node)
      )
      .attr("stroke", () =>
        utils.darkenIfInvertedBackground(
          constants.everythingElseColor,
          this.invertedBackground
        )
      )
      .attr("fill", () =>
  ...
  public applyNodeUnhighlighted(
    ...
    nodeShape
      ...
      .duration(durationLong)
      .attr("d", (d: unknown) =>
        nodeStateUnhighlighted.shapeSuperformula.getPath(d as Node)
      )
      .attr("stroke", () =>
        utils.darkenIfInvertedBackground(
          constants.everythingElseColor,
      ...
      .style(
        "stroke-opacity",
        this.showOnlyHighlighted ? 0 : constants.everythingElseOpacity
      )
      .style(
        "fill-opacity",
        this.showOnlyHighlighted ? 0 : constants.everythingElseOpacity
    ...
    nodeText
      ...
      .duration(durationLong)
      .style("opacity", () =>
        this.showOnlyHighlighted ? 0 : this.showAllLabels ? 1 : 0
      )
      .attr("transform", (d) => {
  ...
  public applyNodeMouseOver(
    ...
    mouseOverTransition.tween("attr:transform", () => {
      ...
      const shiftFrom = utils.nodeTextShiftRight(
        nodeData,
        nodeState.nodeTextShiftMultiplier
      );
      const shiftTo = utils.nodeTextShiftRight(
        nodeData,
        nodeState.nodeTextShiftMultiplier * 1.3
      );
    ...
    if (
      ...
      Number(nodeText.style("opacity")) < 1
    ) {
  ...
  public applyLinkDefault(
    linkEles: d3.Selection<SVGLineElement, Link, d3.BaseType, any>
  ) {
    linkEles
  ...
  public applyLinkGradientDefault(
    linkGradientEles: d3.Selection<
    ...
    stopTwo
      ...
      .attr(
        "stop-color",
        this.invertedBackground
          ? constants.linkGradientColorEndInverted
          : constants.linkGradientColorEnd
      );
  }

  public applyLinkGradientHighlight(
    linkGradientEles: d3.Selection<
      SVGLinearGradientElement,
      Link,
      d3.BaseType,
  ...
  public applyLinkGradientUnhighlighted(
    linkGradientEles: d3.Selection<
      SVGLinearGradientElement,
      Link,
      d3.BaseType,
  ...
  public applyHullDefault(
    hullEles: d3.Selection<SVGPathElement, Hull, BaseType, any>
  ) {
    hullEles
...
function getNodeStateProperties(
  nodeEles: d3.Selection<SVGGElement, Node, d3.BaseType, any>
): NodeStateProperties {
